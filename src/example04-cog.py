...
sys.path.append('/home/lbergmann/ug4/lib/')
# sys.path.append('$HOME/ug4-git/bin/plugins/')4    
print(sys.path)
...
filename="grids/square_copy.ugx" # "square", "corner-mixed"
...
def read_tiff_image(filename):
    ...
    return data
"""
# Altes example tiff wird mit pillow geladen, der cpp code lädt das COG per gdal selber
...
if True:
    try:
        ...
        ## neu
        cog_url = "/vsicurl/https://sentinel-cogs.s3.us-west-2.amazonaws.com/sentinel-s2-l2a-cogs/36/Q/WD/2020/7/S2A_36QWD_20200701_0_L2A/B08.tif"
        py_ud = ijk.COGUserData2d(cog_url, 1)
